 ...
 */
        ...
        static void assertEmpty(Rectangle rect) {
                ...
                Assertions.assertTrue(rect.getWidth() == 0 || rect.getHeight() == 0,
                                "Empty rectangle should either have a " +
        ...
        public void testAddRectangle() {
                ...
                assertValues(rect, minX1X2X3, minY1Y2Y3, maxX1X2X3, maxY1Y2Y3, widthX1X2X3, heightX1X2X3,
                                "when adding " +
                                                "another rectangle");
        }
        ...
        public void testAddSameRectangle() {
                ...
                Assertions.assertFalse(rect.add(rect),
                                "Expected no change when adding equal rectangle using #add(Rectangle)");
                assertValues(rect, minX1X2, minY1Y2, maxX1X2, maxY1Y2, width, height,
                                "when adding the same rectangle to" +
                                                " itself");
        }
